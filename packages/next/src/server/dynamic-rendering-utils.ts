 ...
 * Segments not using runtime prefetch render in the early stages and should
 * wait for EarlyRuntime. Runtime-prefetchable segments render in the later
 * stages and should wait for Runtime.
 */
